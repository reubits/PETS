...
open class URLSessionRequestBuilder<T>: RequestBuilder<T> {
    ...
    @discardableResult
    override open func execute(_ apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> URLSessionTask? {
