...
------------- | ------------- | -------------
[**createUser**](PUserAPI.md#createuser) | **POST** /user | Create user
[**createUsersWithArrayInput**](PUserAPI.md#createuserswitharrayinput) | **POST** /user/createWithArray | Creates list of users with given input array
[**createUsersWithListInput**](PUserAPI.md#createuserswithlistinput) | **POST** /user/createWithList | Creates list of users with given input array
[**deleteUser**](PUserAPI.md#deleteuser) | **DELETE** /user/{username} | Delete user
[**getUserByName**](PUserAPI.md#getuserbyname) | **GET** /user/{username} | Get user by user name
[**loginUser**](PUserAPI.md#loginuser) | **GET** /user/login | Logs user into the system
[**logoutUser**](PUserAPI.md#logoutuser) | **GET** /user/logout | Logs out current logged in user session
[**updateUser**](PUserAPI.md#updateuser) | **PUT** /user/{username} | Updated user
...
// Create user
PUserAPI.createUser(user: user) { (response, error) in
...
// Creates list of users with given input array
PUserAPI.createUsersWithArrayInput(user: user) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Creates list of users with given input array
PUserAPI.createUsersWithListInput(user: user) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete user
PUserAPI.deleteUser(username: username) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get user by user name
PUserAPI.getUserByName(username: username) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Logs user into the system
PUserAPI.loginUser(username: username, password: password) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Logs out current logged in user session
PUserAPI.logoutUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Updated user
PUserAPI.updateUser(username: username, user: user) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
