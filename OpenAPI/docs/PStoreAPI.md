...
------------- | ------------- | -------------
[**deleteOrder**](PStoreAPI.md#deleteorder) | **DELETE** /store/order/{orderId} | Delete purchase order by ID
[**getInventory**](PStoreAPI.md#getinventory) | **GET** /store/inventory | Returns pet inventories by status
[**getOrderById**](PStoreAPI.md#getorderbyid) | **GET** /store/order/{orderId} | Find purchase order by ID
[**placeOrder**](PStoreAPI.md#placeorder) | **POST** /store/order | Place an order for a pet
...
// Delete purchase order by ID
PStoreAPI.deleteOrder(orderId: orderId) { (response, error) in
...
// Returns pet inventories by status
PStoreAPI.getInventory() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Find purchase order by ID
PStoreAPI.getOrderById(orderId: orderId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Place an order for a pet
PStoreAPI.placeOrder(order: order) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
