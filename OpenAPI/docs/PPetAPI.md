...
------------- | ------------- | -------------
[**addPet**](PPetAPI.md#addpet) | **POST** /pet | Add a new pet to the store
[**deletePet**](PPetAPI.md#deletepet) | **DELETE** /pet/{petId} | Deletes a pet
[**findPetsByStatus**](PPetAPI.md#findpetsbystatus) | **GET** /pet/findByStatus | Finds Pets by status
[**findPetsByTags**](PPetAPI.md#findpetsbytags) | **GET** /pet/findByTags | Finds Pets by tags
[**getPetById**](PPetAPI.md#getpetbyid) | **GET** /pet/{petId} | Find pet by ID
[**updatePet**](PPetAPI.md#updatepet) | **PUT** /pet | Update an existing pet
[**updatePetWithForm**](PPetAPI.md#updatepetwithform) | **POST** /pet/{petId} | Updates a pet in the store with form data
[**uploadFile**](PPetAPI.md#uploadfile) | **POST** /pet/{petId}/uploadImage | uploads an image
...
// Add a new pet to the store
PPetAPI.addPet(pet: pet) { (response, error) in
...
// Deletes a pet
PPetAPI.deletePet(petId: petId, apiKey: apiKey) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Finds Pets by status
PPetAPI.findPetsByStatus(status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Finds Pets by tags
PPetAPI.findPetsByTags(tags: tags) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Find pet by ID
PPetAPI.getPetById(petId: petId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update an existing pet
PPetAPI.updatePet(pet: pet) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Updates a pet in the store with form data
PPetAPI.updatePetWithForm(petId: petId, name: name, status: status) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// uploads an image
PPetAPI.uploadFile(petId: petId, additionalMetadata: additionalMetadata, file: file) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
